...
расхождения, логические противоречия, невыполненные обещания, пробелы)
и **чего мы не видим** (упущенные идеи — сверкой с рынком и дашбордами).
...
- **Пробелы** — «провалили между стульев»: что обсуждали, но не закрыли
  планом.

**Чего мы не видим** (сверяет корпус с внешними рамками):
- **Неувиденные возможности и гипотезы** — какие идеи и направления мы
  упускаем. Этого в корпусе нет, поэтому система сверяет корпус с
  **рынком** (практики снаружи), с **дашбордами** (метрики, которые
  стоит смотреть, но не смотрим) и с **другими направлениями Avito**.

**Поверх всего — сверка инициативы:** новую идею сводим со всем
накопленным — что подтверждается, что противоречит, чего не хватает.
...
5 и 7), а не периферия. Помощь в написании (Возможность 6) —
вспомогательная и опциональная.
